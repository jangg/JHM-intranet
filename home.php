...
// include_once "includes/newsmsgs-copy-201119.inc";
					...
					<ul>
						<li>
							<a href="pages/bericht20241218_1.php">
								...
								<p style="font-size: 1.2em;">De Kerstfoto's van 2024. Het zijn er 23.</p>
								<p style="font-size: 1.2em; color: red;">Zien?</p>
