...
if ($userOfPost)
{
	$person = new Person('id', $userOfPost->id_person);
	if ($person)
	{
		$personName = $person->voornaam . ' ' . $person->tussenvoegsels . ' ' . $person->achternaam;
	}
}
...
$forumMessage = str_replace('###naam###', $personName, $forumMessage);
