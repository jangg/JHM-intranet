...
//		echo 'User ' . $this->id . ' is vernietigd<br/>';
	...
	public function __toString()
	{
		...
		return 
			...
			'$berichtInd    : ' . $this->berichtInd        . '<br/>' .
			'$berichtSentInd : ' . $this->berichtSentInd       . '<br/>' .
			'$forumNoteInd : ' . $this->forumNoteInd	   . '<br/>';
	}
	...
	public function insertToDB () 
	{
		...
		{
			  error_log('Connectie (user 1) met de database mislukt: ' . $e->getMessage());
			  return FALSE;
		}
	    return TRUE;	
	}
