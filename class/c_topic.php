...
class Topic
{
	...
	public function saveToDB () 
	{
		...
		{			
			...
			$stmt->bindValue( ":id_cat"			, htmlentities($this->id_cat, ENT_QUOTES, 'UTF-8'), PDO::PARAM_STR);
			$stmt->bindValue( ":id_user"		, htmlentities($this->id_user, ENT_QUOTES, 'UTF-8'), PDO::PARAM_STR);
			$stmt->bindValue( ":nbrPosts"		, htmlentities($this->nbrPosts, ENT_QUOTES, 'UTF-8'), PDO::PARAM_STR);
			$stmt->execute();
	...
	public function updateToDB () 
	{
		...
		try
		{
			...
			$stmt->bindValue( ":id"				, $this->id, PDO::PARAM_STR);
			$stmt->bindValue( ":onderwerp"		, htmlentities($this->onderwerp, ENT_QUOTES, 'UTF-8'), PDO::PARAM_STR);
			$stmt->bindValue( ":datum"			, htmlentities($this->datum, ENT_QUOTES, 'UTF-8'), PDO::PARAM_STR);
			$stmt->bindValue( ":id_cat"			, htmlentities($this->id_cat, ENT_QUOTES, 'UTF-8'), PDO::PARAM_STR);
			$stmt->bindValue( ":id_user"		, htmlentities($this->id_user, ENT_QUOTES, 'UTF-8'), PDO::PARAM_STR);
			$stmt->bindValue( ":nbrPosts"		, htmlentities($this->nbrPosts, ENT_QUOTES, 'UTF-8'), PDO::PARAM_STR);
			$stmt->execute();
