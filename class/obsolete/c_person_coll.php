...
class Person_coll {
    ...
    protected function __construct1 ($orderArr) {
	    /*
    ...
    protected function __construct2 ($selectArr, $orderArr) {
	    /*
    ...
    protected function __construct3 ($selectArr, $orderArr, $limit) {
	    /*
    ...
    protected function buildQuery ($selectArr, $orderArr, $limit) {
		...
		$this->query .= ' WHERE person.deleted = "n" AND person.approved = "j" ';
	    if (!empty($selectArr)) {
