...
class User extends Person
{
	...
	public function readUserWithId ($attr)
	{
		...
		*/
		...
		{
			openDB();
			$sql = "SELECT user.*, person.* FROM user JOIN person ON user.id_person = person.person_id WHERE user.id = :id AND person.delind = 'n' LIMIT 1;";
