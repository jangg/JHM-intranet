...
foreach ($userColl->userColl as $user) 
{
	...
	$html .='
		<tr>
			...
			<td>
				<label>komt naar de maatjesavond op 13 december&nbsp;&nbsp;</label>
...
<div class="jumbotron">
	...
	<div class="container my-5" >
		<h3 class="bluefont">25 november 2023</h3>
		<h1 class="text-black mb-5 bluefont">Deelnamelijst Maatjesavond</h1>
		<p>Op woensdagavond 13 december 2023 organiseert JobHulpMaatje Zoetermeer een maatjesavond voor alle vrijwilligers. Deze wordt gehouden in De Kapelaan.</p>
		<p>Verdere informatie vind je de Whatsapp groep.</p>
		<p>Aanmelden of afmelden is simpel. De knop is grijs als je nog geen keuze hebt gemaakt. Als de schuifknop 1 x aanklikt wordt het 'ja' en geef je aan dat je komt. Als je de knop 2 x aanklikt wordt het, na refresh, 'nee' en geef je dus aan dat je niet komt.</p>
		<p><strong>Schrijf je hier in en kom ook op 13 december.</strong></p>
