...
<html>
	<head>
		<title>Een gelukkig en gezond 2021!</title>
		<style>
		body	{
	...
	<body>
		<div id = "board"></div>
		<center>
			<h1><font style = "font-family:impact;color:red;">Een gelukkig en gezond 2021!<font></h1>
				<h1><font style = "font-family:impact;color:red;"><font></h1>
		</center>
		<audio id="audio2" src="firework_explosion_002.mp3"></audio>
		<audio id="audio1" src="firework_rocket_launch.mp3"></audio>
	</body>
	<script>
