...
require_once('../class/c_jobgroup_coll.php');
...
$pdf = new PresListPDF (PDF_PAGE_ORIENTATION, PDF_UNIT, PDF_PAGE_FORMAT, true, 'UTF-8', false);

// set document information
$pdf->SetCreator(PDF_CREATOR);
$pdf->SetAuthor('Coördinator jobgroup');
$pdf->SetTitle('Presentielijst');
$pdf->SetSubject('met jobgroup deelnemers');
$pdf->SetKeywords('');
