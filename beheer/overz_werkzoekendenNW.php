...
<html lang="nl-NL">
	...
	<body style="background-color: #dddddd;">
        ...
        <div class="container-fluid">
			<div class="row">
				<div class="col-12">
					<table class="data-table table-striped" data-toggle="table" data-search="true" data-pagination="true"  data-page-size="20" data-page-list="20, 40, 60, 80" data-show-columns="true" data-detail-view="true" data-detail-formatter="showwkz">
		...
		<script>
		function showwkz (index, row)
		{
			return row['achternaam'] + ': ' + row['status']
		}
		</script>
	</body>
</html>
