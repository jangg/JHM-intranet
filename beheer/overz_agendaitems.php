...
foreach($agendaitemColl->agendaitemColl as $agendaitem)
{
	...
	<tr style="font-size: 0.9em;">
		...
		<td class="p-0">' . $agendaitem->titel				. '</td>
		<td class="p-0">' . $agendaitem->pubind_intern		. '</td>
		<td class="p-0">' . $agendaitem->datetime_pub_intern	. '</td>
		<td class="p-0">' . $agendaitem->pubind_extern		. '</td>
		<td class="p-0">' . $agendaitem->datetime_pub_extern	. '</td>
		</tr>';
}
?>
