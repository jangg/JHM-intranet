...
{
	$user = new User('emailadres', $_POST['email']);	
	if ($user->id != NULL)
	{		
		$nwpw = randomPassword();
		$user->password = $nwpw;
			...
			<div class="row">
				...
				<div class="col-lg-6">
					...
					<p>Als je de email niet ziet in je Inbox, check dan ook of de email misschien in je spam-email terecht is gekomen. 
						...
						<p>In de email staat je toegangs-id en een tijdelijk wachtwoord. Gebruik deze om in te loggen. Je krijgt dan direct de vraag om een nieuwe, eigen wachtwoord op te geven. Daarna kun je weer op de normale manier terecht op het intranet.</p>
