		  ...
		  <div class="row mt-4">
			<div class="col-12">
			  <div class="d-flex flex-wrap align-items-center gap-2">		
				<!-- Links -->
				<div class="d-flex flex-wrap align-items-center gap-2">
				  <a class="btn btn-primary mr-2" style="min-width:120px" href="beheer.php">Menu</a>
				  <a class="btn btn-primary mr-2" style="min-width:140px" href="mut_newsitem.php">Nieuw nieuwsbericht</a>
				  <a class="btn btn-primary mr-2" style="min-width:140px" href="photolib.php?q=img&r=ni">Afbeeldingen</a>
				</div>
			</div>
		</div></div></div>
        <div class="container-fluid">
